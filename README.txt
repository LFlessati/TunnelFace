The files in this release are the implementation of the approaches proposed in [1] and in [2] for unreinforced and reinforced (with fibreglass pipes) tunnel faces, respectively.
...
The approach in [1] allows to calculate the average face extrusion in case of reinforced deep tunnel faces under undrained condtions. From a practical point of view this value can be used to decide whether the number/length of the reinforcement is sufficient to reach a given target face displacement. Constraints of face displacements can come from a maximum admissible volume loss.

References 
[1] di Prisco, C., Flessati, L., Frigerio, G., & Lunardi, P. (2018). A numerical exercise for the definition under undrained conditions of the deep tunnel front characteristic curve. Acta Geotechnica, 13, 635-649.
